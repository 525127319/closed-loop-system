    ...
    <article>
        ...
        <section class="main">
            <ul class="list-view team-member">
                <li class="list-view-item" v-for="(item,index) in dynamiclist" :key="index">
                    ...
                    <span class="count" v-text="item.dynamicSum"> </span>
                </li>
...
<script>
    export default {
        ...
        methods: {
            ...
            getDynamicCharts() {
                const _this = this;
                this.$axiosHttp.axiosPost("work-xproject/ranking/findDynamicRankingList.do").then(response => {
                    if (response.code = 200) {
                        _this.dynamiclist = response.data;
                    } else {}
                });
